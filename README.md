# Side Navigation Component - Power Platform Canvas App

A demo Power Apps Canvas App showcasing a **side navigation component** UI pattern, provided by [Novalogix](https://www.youtube.com/@Novalogix-ltd) as a companion to a YouTube tutorial video.
...
2. Download the `SideNavigation_1_0_0_1.zip` file from the latest release
...
2. Select all files and folders **inside** the folder (not the folder itself):
   ...
   - `solution.xml`
   - `CanvasApps/`
3. Compress them into a `.zip` file (e.g. `SideNavigation_1_0_0_1.zip`)
...
2. Find **Side Navigation Component** in the list
